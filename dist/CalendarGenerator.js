...
function configFromStringAndFormat(config) {
  ...
  var string = "" + config._i, i, parsedInput, tokens2, token, skipped, stringLength = string.length, totalParsedInputLength = 0, era2, tokenLen;
  ...
  era2 = getParsingFlags(config).era;
  if (era2 !== null) {
    config._a[YEAR] = config._locale.erasConvertYear(era2, config._a[YEAR]);
  }
...
function localeErasConvertYear(era2, year) {
  var dir = era2.since <= era2.until ? 1 : -1;
  if (year === undefined) {
    return hooks(era2.since).year();
  } else {
    return hooks(era2.since).year() + (year - era2.offset) * dir;
  }
}
function getEraName() {
...
var init_moment = __esm(() => {
  ...
  addParseToken(["N", "NN", "NNN", "NNNN", "NNNNN"], function(input, array, config, token) {
    var era2 = config._locale.erasParse(input, token, config._strict);
    if (era2) {
      getParsingFlags(config).era = era2;
    } else {
...
var SUN_GM = 0.0002959122082855911;
var EARTH_GM = 0.0000000008887692390113509;
var JUPITER_GM = 0.0000002825345909524226;
var SATURN_GM = 0.00000008459715185680659;
var URANUS_GM = 0.00000001292024916781969;
var NEPTUNE_GM = 0.00000001524358900784276;
...
class AstroTime {
  ...
  static FromTerrestrialTime(tt) {
    ...
    for (;; ) {
      ...
      if (Math.abs(err) < 0.000000000001)
        return time;
...
function iau2000b(time) {
  ...
  return {
    dpsi: -0.000135 + dp * 0.0000001,
    deps: 0.000388 + de * 0.0000001
  };
}
...
function e_tilt(time) {
  if (!cache_e_tilt || Math.abs(cache_e_tilt.tt - time.tt) > 0.000001) {
...
function CalcMoon(time) {
  ...
  DD = DL0 - DLS;
  DGAM = -0.000003332 * Sine(0.59734 - 5.37261 * T) - 0.000000539 * Sine(0.35498 - 5.37899 * T) - 0.000000064 * Sine(0.39943 - 5.37511 * T);
...
var PlutoStateTable = [
  [-730000, [-26.118207232108, -14.376168177825, 3.384402515299], [0.0016339372163656, -0.0027861699588508, -0.0013585880229445]],
  [-700800, [41.974905202127, -0.448502952929, -12.770351505989], [0.00073458569351457, 0.0022785014891658, 0.00048619778602049]],
  [-671600, [14.706930780744, 44.269110540027, 9.353698474772], [-0.00210001479998, 0.00022295915939915, 0.00070143443551414]],
  [-642400, [-29.441003929957, -6.43016153057, 6.858481011305], [0.00084495803960544, -0.0030783914758711, -0.0012106305981192]],
  [-613200, [39.444396946234, -6.557989760571, -13.913760296463], [0.0011480029005873, 0.0022400006880665, 0.00035168075922288]],
  [-584000, [20.2303809507, 43.266966657189, 7.382966091923], [-0.0019754081700585, 0.00053457141292226, 0.00075929169129793]],
  [-554800, [-30.65832536462, 2.093818874552, 9.880531138071], [0.000061010603013347, -0.0031326500935382, -0.00099346125151067]],
  [-525600, [35.737703251673, -12.587706024764, -14.677847247563], [0.0015802939375649, 0.0021347678412429, 0.00019074436384343]],
  [-496400, [25.466295188546, 41.367478338417, 5.216476873382], [-0.0018054401046468, 0.0008328308359951, 0.00080260156912107]],
  [-467200, [-29.847174904071, 10.636426313081, 12.297904180106], [-0.00063257063052907, -0.0029969577578221, -0.00074476074151596]],
  [262800, [-29.184024803031, -7.371243995762, 6.493275957928], [0.00093581363109681, -0.0030610357109184, -0.0012364201089345]],
  [292000, [39.831980671753, -6.078405766765, -13.909815358656], [0.0011117769689167, 0.0022362097830152, 0.00036230548231153]],
  [321200, [20.294955108476, 43.417190420251, 7.450091985932], [-0.0019742157451535, 0.00053102050468554, 0.00075938408813008]],
  [350400, [-30.66999230216, 2.318743558955, 9.973480913858], [0.000045605107450676, -0.0031308219926928, -0.00099066533301924]],
  [379600, [35.626122155983, -12.897647509224, -14.777586508444], [0.0016015684949743, 0.0021171931182284, 0.00018002516202204]],
  [408800, [26.133186148561, 41.232139187599, 5.00640132622], [-0.0017857704419579, 0.00086046232702817, 0.00080614690298954]],
  [438000, [-29.57674022923, 11.863535943587, 12.631323039872], [-0.00072292830060955, -0.0029587820140709, -0.000708242964503]],
  [467200, [29.910805787391, -19.159019294, -15.013363865194], [0.0020871080437997, 0.0018848372554514, -0.000038528655083926]],
  [496400, [31.375957451819, 38.050372720763, 2.433138343754], [-0.0015546055556611, 0.0011699815465629, 0.00083565439266001]],
  [525600, [-26.360071336928, 20.662505904952, 14.414696258958], [-0.0013142373118349, -0.0026236647854842, -0.00042542017598193]],
  [554800, [22.599441488648, -24.508879898306, -14.484045731468], [0.0025454108304806, 0.0014917058755191, -0.00030243665086079]],
  [584000, [35.877864013014, 33.894226366071, -0.224524636277], [-0.0012941245730845, 0.0014560427668319, 0.00084762160640137]],
  [613200, [-21.538149762417, 28.204068269761, 15.321973799534], [-0.001731211740901, -0.0021939631314577, -0.0001631691327518]],
  [642400, [13.971521374415, -28.339941764789, -13.083792871886], [0.0029334630526035, 0.00091860931752944, -0.00059939422488627]],
  [671600, [39.526942044143, 28.93989736011, -2.872799527539], [-0.0010068481658095, 0.001702113288809, 0.00083578230511981]],
  [700800, [-15.576200701394, 34.399412961275, 15.466033737854], [-0.0020098814612884, -0.0017191109825989, 0.000070414782780416]],
  [730000, [4.24325283709, -30.118201690825, -10.707441231349], [0.0031725847067411, 0.0001609846120227, -0.00090672150593868]]
];
...
var Months;
((Months2) => {
  Months2[Months2["Aries"] = 1] = "Aries";
  Months2[Months2["Taurus"] = 2] = "Taurus";
  Months2[Months2["Gemini"] = 3] = "Gemini";
  Months2[Months2["Cancer"] = 4] = "Cancer";
  Months2[Months2["Leo"] = 5] = "Leo";
  Months2[Months2["Virgo"] = 6] = "Virgo";
  Months2[Months2["Libra"] = 7] = "Libra";
  Months2[Months2["Scorpio"] = 8] = "Scorpio";
  Months2[Months2["Sagittarius"] = 9] = "Sagittarius";
  Months2[Months2["Capricorn"] = 10] = "Capricorn";
  Months2[Months2["Aquarius"] = 11] = "Aquarius";
  Months2[Months2["Pisces"] = 12] = "Pisces";
})(Months ||= {});
var calendar2 = [];
var observer;
function generateCalendarYear(eventList) {
  ...
  console.log("Initial currentDate UTC for loop:", currentDate.toISOString());
  ...
  while (currentDate.isBefore(eventList.SpringEquinox2, "day")) {
    ...
    if (degreeRangeCoversBirthTarget) {
      ...
      while (low <= high && iterations < maxIterations) {
        ...
        const testMoment = import_moment_timezone.default(mid);
    ...
    if (finalFoundBirthMoment.format("MM/DD/YY") == currentDate.format("MM/DD/YY")) {
      ...
      events = equinoxSolsticeEvents.filter((event) => event.date.format("MM/DD/YY") === currentDate.format("MM/DD/YY")).map((event) => ({ name: event.name, description: event.description, date: event.date.format("YYYY-MM-DD HH:mm:ss") }));
    }
    const day = {
  ...
  calendar2.length = 0;
  calendar2.push(...newCalendar);
}
var getDegree = (helioLongitude, springEquinoxLongitude) => parseFloat(((helioLongitude - springEquinoxLongitude + 360) % 360).toFixed(2));
var eventList = (year, birth) => {
  const season = Seasons(year);
  const nextSeason = Seasons(year + 1);
  const Apsis2 = SearchPlanetApsis(Body.Earth, new Date(year, 4, 1));
  const list = {
    SpringEquinox: import_moment_timezone.default(season.mar_equinox.toString()).utc(),
    SummerSolstice: import_moment_timezone.default(season.jun_solstice.toString()).utc(),
    AutumnEquinox: import_moment_timezone.default(season.sep_equinox.toString()).utc(),
    WinterSolstice: import_moment_timezone.default(season.dec_solstice.toString()).utc(),
    SpringEquinox2: import_moment_timezone.default(nextSeason.mar_equinox.toString()).utc(),
    Aphelion: import_moment_timezone.default(Apsis2.time.toString()).utc(),
    Perihelion: import_moment_timezone.default(NextPlanetApsis(Body.Earth, Apsis2).time.toString()).utc(),
    Birth: birth
  };
  return list;
};
var getDayInfo = (date) => {
  let SolarNoon = import_moment_timezone.default(SearchHourAngle(Body.Sun, observer, 0, date).time.toString());
  ...
  const SolarStart = import_moment_timezone.default(SearchHourAngle(Body.Sun, observer, 12, SolarNoon.toDate(), -1).time.toString()).utc();
  const SolarEnd = import_moment_timezone.default(SearchHourAngle(Body.Sun, observer, 12, SolarNoon.toDate(), 1).time.toString()).utc();
  const TimeInDay = SolarEnd.diff(SolarStart);
  const sign2 = TimeInDay >= 86400000 ? "+" : "-";
...
function getBirthDegree(birthDate) {
  ...
  if (birthDate < import_moment_timezone.default(BirthYearSeasons.mar_equinox.toString()).utc()) {
    const previousSeasons = Seasons(birthDate.year() - 1);
    springEquinoxLongitude = getHeliocentricLongitude(import_moment_timezone.default(previousSeasons.mar_equinox.toString()).utc().toDate());
  } else {
    springEquinoxLongitude = getHeliocentricLongitude(import_moment_timezone.default(BirthYearSeasons.mar_equinox.toString()).utc().toDate());
  }
  let BirthLongitude = getHeliocentricLongitude(birthDate.utc().toDate());
  return getDegree(BirthLongitude, springEquinoxLongitude);
}
var birthProfile = {
  observer: new Observer(41.45438, -74.43042, 0),
  date: import_moment_timezone.default.tz("2000-02-04 10:00", "YYYY-MM-DD HH:mm", "America/New_York").utc()
};
var generateCalendar = () => {
  observer = birthProfile.observer;
  let events = eventList(2025, birthProfile.date);
  console.log("Initial eventList.SpringEquinox UTC:", events.SpringEquinox.toISOString());
